...
create table if not exists news_clusters (
  ...
  source_priority_weight numeric(5,2) not null default 0,
  domestic_platform_heat_score int not null default 0,
  douyin_heat_score int not null default 0,
  wechat_channels_heat_score int not null default 0,
  xiaohongshu_heat_score int not null default 0,
...
create table if not exists content_topics (
  ...
  hot_source text,
  why_short_video text,
  recommended_script_angle text,
...
create table if not exists topic_platform_adaptations (
  id uuid primary key default gen_random_uuid(),
  topic_id uuid references content_topics(id) on delete cascade,
